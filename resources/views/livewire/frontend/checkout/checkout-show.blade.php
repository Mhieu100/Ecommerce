                            ...
                            <form action="" method="POST">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" wire:model.defer.defer="fullname" class="form-control"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="d-md-flex align-items-start">
                                            <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab"
                                                ...
                                                <button wire:loading.attr="disabled" class="nav-link fw-bold border" id="cashOnDeliveryTab-tab"
                                                ...
                                                <button wire:loading.attr="disabled" class="nav-link fw-bold border active" id="onlinePayment-tab"
                                            ...
                                            <div class="tab-content col-md-9" id="v-pills-tabContent">
                                                <div class="tab-pane fade active show" id="cashOnDeliveryTab"
                                                    ...
                                                    <hr />
                                                    <button wire:loading.attr="disabled" type="button" wire:click="codOrder"
